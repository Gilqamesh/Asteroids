...
extern "C"
{
    ...
    // defining a font u8 white Rectangle would allow drawing everything in a single draw call
    void RL_SetShapesTexture(Texture2D texture, Rectangle source)       // Set texture and Rectangle to be used on shapes drawing
    {
    ...
    void RL_DrawRectangle(i32 posX, i32 posY, i32 width, i32 height, Color color)                        // Draw a color-filled Rectangle
    {
        DrawRectangle(posX, posY, width, height, color);
    }
    void RL_DrawRectangleV(Vector2 position, Vector2 size, Color color)                                  // Draw a color-filled Rectangle (Vector version)
    {
        DrawRectangleV(position, size, color);
    }
    void RL_DrawRectangleRec(Rectangle rec, Color color)                                                 // Draw a color-filled Rectangle
    {
        DrawRectangleRec(rec, color);
    }
    void RL_DrawRectanglePro(Rectangle rec, Vector2 origin, r32 rotation, Color color)                 // Draw a color-filled Rectangle with pro parameters
    {
        DrawRectanglePro(rec, origin, rotation, color);
    }
    void RL_DrawRectangleGradientV(i32 posX, i32 posY, i32 width, i32 height, Color color1, Color color2)// Draw a vertical-gradient-filled Rectangle
    {
        DrawRectangleGradientV(posX, posY, width, height, color1, color2);
    }
    void RL_DrawRectangleGradientH(i32 posX, i32 posY, i32 width, i32 height, Color color1, Color color2)// Draw a horizontal-gradient-filled Rectangle
    {
        DrawRectangleGradientH(posX, posY, width, height, color1, color2);
    }
    void RL_DrawRectangleGradientEx(Rectangle rec, Color col1, Color col2, Color col3, Color col4)       // Draw a gradient-filled Rectangle with custom vertex colors
    {
        DrawRectangleGradientEx(rec, col1, col2, col3, col4);
    }
    void RL_DrawRectangleLines(i32 posX, i32 posY, i32 width, i32 height, Color color)                   // Draw Rectangle outline
    {
        DrawRectangleLines(posX, posY, width, height, color);
    }
    void RL_DrawRectangleLinesEx(Rectangle rec, r32 lineThickness, Color color)                            // Draw Rectangle outline with extended parameters
    {
        DrawRectangleLinesEx(rec, lineThickness, color);
    }
    void RL_DrawRectangleRounded(Rectangle rec, r32 roundness, i32 segments, Color color)              // Draw Rectangle with rounded edges
    {
        DrawRectangleRounded(rec, roundness, segments, color);
    }
    void RL_DrawRectangleRoundedLines(Rectangle rec, r32 roundness, i32 segments, r32 lineThick, Color color) // Draw Rectangle with rounded edges outline
    {
    ...
    b32 RL_CheckCollisionRecs(Rectangle rec1, Rectangle rec2)                                           // Check collision between two Recs
    {
    ...
    b32 RL_CheckCollisionCircleRec(Vector2 center, r32 radius, Rectangle rec)                         // Check collision between circle and Rectangle
    {
        return (CheckCollisionCircleRec(center, radius, rec));
    }
    b32 RL_CheckCollisionPointRec(Vector2 point, Rectangle rec)                                         // Check if point is inside Rectangle
    {
    ...
    Rectangle RL_GetCollisionRec(Rectangle rec1, Rectangle rec2)                                         // Get collision Rectangle for two Recs collision
    {
    ...
    Image RL_ImageFromImage(Image image, Rectangle rec)                                                  // Create an image from another image piece
    {
    ...
    void RL_ImageCrop(Image *image, Rectangle crop)                                                      // Crop an image to a defined Rectangle
    {
    ...
    Rectangle RL_GetImageAlphaBorder(Image image, r32 threshold)                                       // Get image alpha border Rectangle
    {
    ...
    void RL_ImageDrawRectangle(Image *dst, i32 posX, i32 posY, i32 width, i32 height, Color color)       // Draw Rectangle within an image
    {
        ImageDrawRectangle(dst, posX, posY, width, height, color);
    }
    void RL_ImageDrawRectangleV(Image *dst, Vector2 position, Vector2 size, Color color)                 // Draw Rectangle within an image (Vector version)
    {
        ImageDrawRectangleV(dst, position, size, color);
    }
    void RL_ImageDrawRectangleRec(Image *dst, Rectangle rec, Color color)                                // Draw Rectangle within an image
    {
        ImageDrawRectangleRec(dst, rec, color);
    }
    void RL_ImageDrawRectangleLines(Image *dst, Rectangle rec, i32 thick, Color color)                   // Draw Rectangle lines within an image
    {
        ImageDrawRectangleLines(dst, rec, thick, color);
    }
    void RL_ImageDraw(Image *dst, Image src, Rectangle srcRec, Rectangle dstRec, Color tint)             // Draw a source image within a destination image (tint applied to source)
    {
    ...
    void RL_UpdateTextureRec(Texture2D texture, Rectangle rec, const void *pixels)                       // Update GPU texture Rectangle with new data
    {
    ...
    void RL_DrawTextureRec(Texture2D texture, Rectangle source, Vector2 position, Color tint)            // Draw a part of a texture defined by a Rectangle
    {
        DrawTextureRec(texture, source, position, tint);
    }
    void RL_DrawTextureQuad(Texture2D texture, Vector2 tiling, Vector2 offset, Rectangle quad, Color tint)  // Draw texture quad with tiling and offset parameters
    {
        DrawTextureQuad(texture, tiling, offset, quad, tint);
    }
    void RL_DrawTextureTiled(Texture2D texture, Rectangle source, Rectangle dest, Vector2 origin, r32 rotation, r32 scale, Color tint) // Draw part of a texture (defined by a Rectangle) with rotation and scale tiled into dest.
    {
        DrawTextureTiled(texture, source, dest, origin, rotation, scale, tint);
    }
    void RL_DrawTexturePro(Texture2D texture, Rectangle source, Rectangle dest, Vector2 origin, r32 rotation, Color tint)           // Draw a part of a texture defined by a Rectangle with 'pro' parameters
    {
        DrawTexturePro(texture, source, dest, origin, rotation, tint);
    }
    void RL_DrawTextureNPatch(Texture2D texture, NPatchInfo nPatchInfo, Rectangle dest, Vector2 origin, r32 rotation, Color tint)   // Draws a texture (or part of it) that stretches or shrinks nicely
    {
    ...
    Image RL_GenImageFontAtlas(const GlyphInfo *chars, Rectangle **recs, i32 glyphCount, i32 fontSize, i32 padding, i32 packMethod) // Generate image font atlas using chars info
    {
    ...
    Rectangle RL_GetGlyphAtlasRec(Font font, i32 codepoint)                                 // Get glyph Rectangle in font atlas for a codepoint (unicode character), fallback to '?' if not found
    {
    ...
    void RL_DrawCubeTextureRec(Texture2D texture, Rectangle source, Vector3 position, r32 width, r32 height, r32 length, Color color) // Draw cube with a region of a texture
    {
    ...
    void RL_DrawBillboardRec(Camera camera, Texture2D texture, Rectangle source, Vector3 position, Vector2 size, Color tint) // Draw a billboard texture defined by source
    {
        DrawBillboardRec(camera, texture, source, position, size, tint);
    }
    void RL_DrawBillboardPro(Camera camera, Texture2D texture, Rectangle source, Vector3 position, Vector3 up, Vector2 size, Vector2 origin, r32 rotation, Color tint) // Draw a billboard texture defined by source and rotation
    {
